  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="flex items-center space-x-4">
              ...
              {user ? (
                <div className="flex items-center space-x-4">
                  ...
                  <Link
                    href="/c"
                    className="bg-primary text-primary-foreground px-4 py-2 rounded-lg hover:opacity-90 transition-colors text-sm"
                  >
                  ...
                  <button
                    ...
                    className="bg-destructive text-destructive-foreground px-4 py-2 rounded-lg hover:opacity-90 transition-colors text-sm disabled:opacity-50"
                  >
                ...
                <div className="flex items-center space-x-3">
                  <Link
                    href="/signup"
                    className="bg-card text-primary border border-primary px-4 py-2 rounded-lg hover:bg-primary/10 transition-colors text-sm"
                  >
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          {!user && (
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/login"
                className="bg-primary text-primary-foreground px-8 py-4 rounded-xl hover:opacity-90 transition-all transform hover:scale-105 text-lg font-semibold shadow-lg"
              >
                {t('start_learning_now', { ns: 'home', defaultValue: 'Start Learning Now' })}
              </Link>
              <Link
                href="/signup"
                className="bg-card text-primary border-2 border-primary px-8 py-4 rounded-xl hover:bg-primary/10 transition-all text-lg font-semibold"
              >
                {t('create_account', { ns: 'navigation', defaultValue: 'Create Account' })}
              </Link>
              <Link
                href="/c"
                className="bg-card text-muted-foreground px-8 py-4 rounded-xl hover:bg-muted/50 transition-all border-2 border-border text-lg font-semibold"
              >
        ...
        {contents.length > 5 && (
          <div className="mb-12">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-card/60 backdrop-blur-sm rounded-2xl p-6 border border-border hover:shadow-lg transition-all">
            ...
            <>
              ...
              {contents.length <= 5 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
                  {contents.map((content) => (
                    <div
                      key={content.id}
                      className="bg-card/80 backdrop-blur-sm rounded-2xl p-6 border border-border hover:shadow-xl transition-all transform hover:-translate-y-1 cursor-pointer group"
                      onClick={() => {
                    ...
                    >
                      <div className="mb-4">
                        <div className="w-full h-40 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-xl mb-4 flex items-center justify-center">
              ...
              {contents.length > 5 && (
                <div className="text-center mt-8">
                  <Link
                    href="/c"
                    className="inline-block bg-primary text-primary-foreground px-8 py-3 rounded-xl hover:opacity-90 transition-all transform hover:scale-105 font-semibold"
                  >
        ...
        {/* 统计数据 - 内容少时简化 */}
        {contents.length > 0 && (
          <div className="bg-card/60 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-border mb-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center">
              <div>
                <div className="text-2xl md:text-3xl font-bold text-primary mb-1">{totalContentCount}+</div>
                <div className="text-sm md:text-base text-muted-foreground">
                  {t('interactive_content', { ns: 'home', defaultValue: 'Interactive Content' })}
                </div>
              </div>
              <div>
                <div className="text-2xl md:text-3xl font-bold text-secondary mb-1">1+</div>
                <div className="text-sm md:text-base text-muted-foreground">
